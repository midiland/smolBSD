...
## Manually build an image with nitro
...
$ sudo mount -o loop images/frankenbase.img mnt # mount the image onto ./mnt
$ export VERSION=0.3.0.0.20250907
$ curl -L -s -o pkgs/nitro.tgz https://imil.net/NetBSD/nitro-${VERSION}.tgz
...
$ sudo mknod -m 666 mnt/dev/constty c 0 1
$ sudo mkdir -p mnt/etc/nitro mnt/usr/pkg/etc/nitro # create config/support dir for nitro
